...
export const endpoint = process.env.NEXT_PUBLIC_SOLANA_RPC_URL;
  ...
  createToken = async (
    ...
    try {
      ...
      const createIx = await program.methods
        .launch(
          coinData.decimals,
          new anchor.BN(TOKEN_RESERVES * Math.pow(10, coinData.decimals)),
          new anchor.BN(LAMPORT_RESERVES * Math.pow(10, 9)),
          coinData.name,
          coinData.symbol,
          coinData.uri
        )
