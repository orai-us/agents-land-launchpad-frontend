...
const pinataApiKey: string | undefined = import.meta.env.VITE_PINATA_API_KEY;
const pinataSecretApiKey: string | undefined = import.meta.env.VITE_PINATA_SECRET_API_KEY;
