...
const chartStyleOverrides = ['candleStyle', 'hollowCandleStyle', 'haStyle'].reduce((acc: Record<string, string | boolean>, cv) => {
...
export const disabledFeaturesOnMobile: ChartingLibraryFeatureset[] = ['header_saveload', 'header_fullscreen_button', 'left_toolbar'];
