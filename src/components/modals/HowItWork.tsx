        ...
        <div className="">
          ...
          <div className="w-full flex justify-between items-center bg-[#080A14] border border-[#1A1C28] rounded-lg p-4">
            ...
            <a
              ...
              className="cursor-pointer p-2 flex items-center bg-[#1A1C28] rounded text-[#E8E9EE] text-[14px] hover:brightness-125"
            >
              CREATE
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex flex-col gap-6 z-10">
              {STEP_WORK.map((step, key) => {
                return (
                  <div
                    key={`${key}-step-work-`}
                    className="flex items-center gap-4 text-[14px] text-[#E8E9EE]"
                  >
                    <div className="p-[10px] w-8 h-8 flex items-center justify-center rounded-full bg-[#1A1C28]">
                      {key + 1}
                    </div>
                    <div>{step}</div>
                  </div>
