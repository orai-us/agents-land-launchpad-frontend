  ...
  return (
    <>
      <div className="w-full flex flex-col xs:flex-row gap-3 items-center justify-between">
        {FilterText.map((item) => (
          <div key={item.id} onClick={() => handleSortSelection('creation time')} className="w-full gap-2 flex flex-row items-center bg-[#143F72] hover:bg-custom-gradient py-2 rounded-lg justify-center cursor-pointer text-lg">
