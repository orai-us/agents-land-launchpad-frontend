...
const Banner = () => {
  ...
  const bondingCurvePercentOrg = new BigNumber((kothCoin?.lamportReserves || 0).toString() || 0).multipliedBy(100).div(BONDING_CURVE_LIMIT);
      ...
      <div className="w-full h-[450px] relative bg-banner flex items-center justify-center">
        <div className="h-full flex justify-between items-center w-full max-w-[1216px]">
          <div className="flex flex-col items-start">
            ...
            <div className="mt-6 mb-14 text-base font-medium text-[#E8E9EE]">The First AI Agent Launch Platform</div>
            <div onClick={() => handleToRouter('/create-coin')} className="uppercase p-1 rounded border-[2px] border-solid border-[rgba(255,255,255,0.25)] cursor-pointer hover:border-[rgba(255,255,255)] transition-all ease-in duration-150">
              <div className="rounded bg-white px-6 py-2 text-[#080A14]">Launch your AGENT</div>
            </div>
          </div>
          {kothCoin && (
            // <div className="bg-[linear-gradient(180deg,_#E4775D_0%,_#292D46_100%)] rounded-xl p-0.5">
            <div className="relative bg-[#E4775D] rounded-xl p-0.5 min-w-[310px] cursor-pointer" onClick={() => handleToRouter(`/trading/${kothCoin.token}`)}>
              <img src={badgeKothImg} alt="badgeKothImg" className="absolute bottom-0 left-[6px] translate-y-1/2" />
              <img src={crownImg} alt="crownImg" className="absolute top-0 right-[6px] -translate-y-1/2 translate-x-1/2" />
              <div className="bg-[linear-gradient(180deg,_#080A14_0%,_#292D46_100%)] rounded-xl flex items-center gap-3 px-6 py-4">
                <div className="">
                  <img src={kothCoin.url} alt="richolman" className="border-[3px] solid rounded-full border-[#E8E9EE] w-[78px] h-[78px]" />
                ...
                <div className="flex flex-col text-[#E8E9EE]">
                  <div className="text-[#84869A] uppercase text-[12px]">
                    create by&nbsp;
                    <span className="text-[#E4775D] underline ">{reduceString(kothCoin.creator?.wallet || '', 4, 4)}</span>
                  </div>
                  ...
                  <div className="text-[#9192A0] text-[12px] uppercase mt-4 ">
                    ...
                    <span className="text-[#E8E9EE]">
                      {formatNumberKMB(Number(kothCoin.marketcap || 0))}({bondingCurvePercent}%)
                    </span>
                  </div>
